var calUtil = {
  ...
  drawCal : function(iYear, iMonth ,signList) {
   ...
   if(calUtil.showMonth>(myDate.getMonth())&&calUtil.showYear==(myDate.getFullYear())){
      
   }else{
    htmls.push("<div class='calendar_month_next'>下月<i class='iconfont'>&#xe62a;</i></div>");
   }

   htmls.push("<div class='calendar_month_prev'><i class='iconfont'>&#xe62b;</i>上月</div>");
   ...
   for (w = 1; w < 7; w++) {
    ...
    for (d = 0; d < 7; d++) {
     ...
     if(ifHasSigned){
      ...
      if(calUtil.showMonth==(myDate.getMonth()+1)&&myMonth[w][d]==myDate.getDate()){
