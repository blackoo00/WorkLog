...
<head>
  ...
  <link rel="stylesheet" href="<?php echo (PROJECT); ?>/nprogress/css/style.css">
  <link rel="stylesheet" href="<?php echo (PROJECT); ?>/nprogress/css/nprogress.css">
  ...
  <script src='<?php echo (PROJECT); ?>/nprogress/js/nprogress.js'></script>
